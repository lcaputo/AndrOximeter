...
public class HeartRateProcess extends Activity {
    ...
    private final PreviewCallback previewCallback = new PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            // El primer parametro representa la intensidad del rojo, 2do para el azul, 3ro para el verde
            GreenAvg = ImageProcessing.decodeRedBlueGreenAvg(data.clone(), height, width, 3);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(HeartRateProcess.this, MainActivity.class);
        i.putExtra("Usr", user);
        startActivity(i);
        finish();
    }
