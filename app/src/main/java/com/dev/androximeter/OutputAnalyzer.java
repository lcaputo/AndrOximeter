            ...
            public void onTick(long millisUntilFinished) {
                ...
                Thread thread = new Thread(() -> {
                    ...
                    if (detectValley()) {
                        ...
                        sendMessage(HeartRateProcess.MESSAGE_UPDATE_REALTIME, currentValue);
                    }
            ...
            public void onFinish() {
                ...
                if (valleys.size() == 0) {
                    mainHandler.sendMessage(Message.obtain(
                            mainHandler,
                            HeartRateProcess.MESSAGE_CAMERA_NOT_AVAILABLE,
                ...
                sendMessage(HeartRateProcess.MESSAGE_UPDATE_FINAL, returnValueSb.toString());
